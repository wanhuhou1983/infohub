          ...
          for (const item of items) {
            try {
              ...
              const insertedRows = await sql`
                ...
                VALUES (${upper.id}, ${title}, ${content}, ${title.slice(0, 150)}, ${videoUrl}, ${publishedAt}, ${category}, ${tags}, ${contentHash}, NOW(), ${author}, ${extra})
              ...
              if (insertedRows.length > 0) {
                ...
                await saveArticleFile(newId, content, {
                  id: newId, title, source_type: 'youtube-updates',
